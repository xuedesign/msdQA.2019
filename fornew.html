...
<title>有話大聲說 ASK CLT | 關於合併 For New MSD</title>
...
<div id="wrapper" class="wrapper">
	<div id="top_section" class="top_section">
		...
		<div id="top_menu" class="top_menu">
			<ul class="top_menu_item">
				...
				<li class="active"><a href="fornew.aspx"><img alt="關於合併 For New MSD" title="關於合併 For New MSD" src="images/msd_topmenu_04.png" /></a></li>
			</ul>
		</div>
	</div>
	...
	<div id="qanda_menu_section" class="qanda_menu_section">
		<div id="qanda_menu" class="qanda_menu">
			<a href="general.aspx"><img alt="一般問題 (General Question)" title="一般問題 (General Question)" src="images/msd_qandamenu_01.png" /></a><a href="historical.aspx"><img alt="歷史問題 (Historical Data)" title="歷史問題 (Historical Data)" src="images/msd_qandamenu_02.png" /></a><img alt="關於合併 (For New MSD)" title="關於合併 (For New MSD)" src="images/msd_qandamenu_03on.png" />
		</div>
    ...
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [Suggestion / Comments:] AS Suggestion, [Answer], format(CreatedDate, 'yyyy/mm/dd') AS CreatedDate FROM [SuggestionData] WHERE Question_Type = '關於合併' AND Post = -1 ORDER BY [CreatedDate] DESC">
        <SelectParameters>
